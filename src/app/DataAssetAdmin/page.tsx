          ...
          <table className="w-full pt-4">
            <thead>
              <tr className="border-b pb-6">
                ...
                <th className="px-3 py-1 text-left font-bold text-customBlue">Category</th>
                <th className="px-3 py-1 text-left font-bold text-customBlue">Condition</th>
                <th className="px-3 py-1 text-left font-bold text-customBlue">Storage Location</th>
              </tr>
            </thead>
            <tbody>
